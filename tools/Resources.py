...
TEMPLATE_PATH.append('%s/assetconf' % gl.get_value('vwdir'))
TEMPLATE_PATH.append('%s/taskconf' % gl.get_value('vwdir'))
TEMPLATE_PATH.append('%s/saltconf' % gl.get_value('vwdir'))

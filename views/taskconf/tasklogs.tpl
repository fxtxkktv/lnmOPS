%rebase base position='任务执行日志', managetopli="opsconf"
<div class="page-body">
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="widget">
                <div class="widget-header bordered-bottom bordered-themesecondary">
                    ...
                    <span class="widget-caption themesecondary">任务执行日志: #名称: {{info.get('taskname','')}} #任务ID: {{info.get('id','')}}</span>
                ...
                <div style="padding:-10px 0px;" class="widget-body no-padding">
                    <div class="tickets-container">
                        <div class="table-toolbar" style="float:left">
                            <a id="log" href="/taskconf/alllist" class="btn btn-primary ">
                                <i class="btn-label fa fa-plus"></i>返回任务列表
                            </a>
			                %if msg.get('message'):
...
$(function(){
    ...
    */
    ...
    $('#myLoadTable').bootstrapTable({
          method: 'post',
          url: '/api/gettasklogs/{{info.get('id','')}}',
